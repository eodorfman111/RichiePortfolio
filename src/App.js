...
const AppContent = () => {
  ...
  return (
    <ThemeProvider theme={theme === 'light' ? lightTheme : darkTheme}>
      <Helmet>
        <title>Richard Jackson | Portfolio</title>
        <meta
          name="description"
          content="Richard Jackson's professional portfolio showcasing skills, projects, and experiences."
        />
        <meta
          name="keywords"
          content="Richard Jackson, Portfolio, Southern Methodist University, Projects, Skills"
        />
